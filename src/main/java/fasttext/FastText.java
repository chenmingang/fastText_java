...
public class FastText implements Serializable{
	...
	public FastText(String binFile) throws IOException {
		...
		model = new Model(args, input, output, args.dim, (float) args.lr, 1);
...
//    }
	...
	public String predictStr(Dictionary dict, Model model, String str) throws IOException {
		java.util.Vector<Integer> line = new java.util.Vector<Integer>();
		java.util.Vector<Integer> labels = new java.util.Vector<Integer>();
...
//    }
	...
	public String predictStr(String binFile, String str) throws IOException {
		...
		return predictStr(dict, model, str);
	}
//
...
//                    printPredictUsage();
			...
			} else if ("predictStr".equalsIgnoreCase(command)) {
				if (args.length != 3) {
//                    printPredictUsage();
					System.exit(1);
				}
				op.predictStr(args[1], args[2]);
			} else {
//                printUsage();
				System.exit(1);
			}
